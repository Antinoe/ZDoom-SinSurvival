...
Class SinSurvivalGelIcePack : SinPowerup{
	Default{
		...
		Tag "Gel Ice Pack";
		SinItem.Description "A flexible, reusable pouch filled with gel that retains cold temperatures for an extended period after being chilled. It is commonly used to reduce swelling, alleviate pain, and provide cold therapy for injuries or sore muscles.";
		SinItem.Stackable 1;
...
Class SinSurvivalBandage : SinPowerup{
	Default{
		...
		Tag "Bandage";
		SinItem.Description "Strips of fabric or gauze used to cover wounds, protect injured areas, and support healing by keeping the area clean and secure. They come in various forms, such as adhesive strips or elastic wraps, and are commonly used in first aid to stop bleeding and provide compression.";
		SinItem.Stackable 1;
		SinItem.SpawnSaveDrives 0;
	}
	States{Spawn: STIM A -1; Stop;}
...
Class SinSurvivalSuture : SinPowerup{
	Default{
		...
		Tag "Suture";
		SinItem.Description "Surgical threads used to close wounds or incisions, designed to naturally dissolve in the body over time. Made from materials like polyglycolic acid or catgut, they eliminate the need for removal and are commonly used in internal surgeries or areas with minimal tension.";
		SinItem.Stackable 1;
		SinItem.SpawnSaveDrives 0;
	...
	States{Spawn: STIM A -1; Stop;}
	Override bool Use(bool pickup){
		owner.GiveInventory("HealBleeding",3);
		owner.GiveInventory("HealLaceration",5);
...
Class SinSurvivalAlcoholWipe : SinPowerup{
	Default{
		...
		Tag "Alcohol Wipes";
		SinItem.Description "Small, pre-moistened cloths saturated with isopropyl alcohol or ethanol, used to disinfect skin or surfaces by killing bacteria. They are commonly used in medical settings for cleaning the skin before injections or treating minor wounds.";
		SinItem.Stackable 1;
		SinItem.SpawnSaveDrives 0;
		SinPowerup.PowerupType "";
	}
...
Class SinSurvivalAntibioticGlue : SinPowerup{
	Default{
		...
		Tag "Antibiotic Glue";
		SinItem.Description "A medical adhesive infused with antimicrobial agents, used to close minor cuts and wounds while preventing infection. It forms a protective barrier over the injury, promoting healing without the need for stitches in less severe cases.";
		SinItem.Stackable 1;
		SinItem.SpawnSaveDrives 0;
		SinPowerup.PowerupType "";
	}
