...
Class HealBloodLoss : HealInjury{
	Default{HealInjury.TimerTicks 70;}
	Override void HealTick(){
		let hasBloodLoss = owner.FindInventory("InjuryBloodLoss",1);
		If(hasBloodLoss){
			owner.GiveBody(1);
			owner.TakeInventory("InjuryBloodLoss",1);
			owner.TakeInventory("HealBloodLoss",1);
		}
	}
}
